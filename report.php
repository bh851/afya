...
if (isset($_POST['search_patient'])) {
    ...
    $sql = "SELECT * FROM registration WHERE registrationdate LIKE '%$search%' ";
} else {
...
<form action="" method="post">
    <div class="search">
        <input type="date" name="search_patient" placeholder="Search patient" value="<?= htmlspecialchars($search) ?>" />
